...
export default function BookingsModule({ targetBookingId, theme = 'dark', userRole = '', currentUser = null }) {
  ...
  const [formData, setFormData] = useState({
    ...
    // eksternal. Cuma catetan referensi buat rekap — perhitungan/pembayaran
    // komisi TC SENGAJA nggak ada di sistem (nominal komisi TC bersifat
    // rahasia). Buat Mitra/Agen, komisi aktualnya tetap diformalkan lewat
      ...
      <html>
        <head>
          ...
          <style>
            ...
            .summary-footer-grid { display: grid; grid-template-columns: 260px 1fr; gap: 16px; align-items: end; margin-bottom: 20px; }
            .summary-footer-left { display: flex; flex-direction: column; gap: 10px; }
            .bank-info { background-color: #f0fdf4; border: 1px dashed #a7f3d0; padding: 10px 12px; border-radius: 8px; font-size: 10.5px; color: #065f46; line-height: 1.5; box-sizing: border-box; }
            ...
            .final-footer-grid { display: grid; grid-template-columns: 1fr 260px; gap: 16px; align-items: center; margin-top: 6px; border-top: 1px solid #e2e8f0; padding-top: 14px; }
          ...
          <div className={`${styles.cardBg} border rounded-2xl w-full max-w-lg p-6 relative max-h-[90vh] overflow-y-auto`}>
            ...
            <form onSubmit={handleSubmit} className={`space-y-4 text-xs ${styles.textSub}`}>
              ...
              <div className={`${styles.innerBg} p-4 rounded-xl border space-y-3`}>
                ...
                <p className="text-[10px] opacity-70 -mt-2">Catetan closing pemesanan ini dari TC/CS siapa atau Mitra/Agen mana — buat rekap. (Perhitungan komisi TC nggak ada di sistem ini.)</p>
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    ...
                    <select
                      ...
                      onChange={e => setFormData({ ...formData, closingSourceType: e.target.value, closingSourceId: '', closingSourceName: '' })}
                    >
